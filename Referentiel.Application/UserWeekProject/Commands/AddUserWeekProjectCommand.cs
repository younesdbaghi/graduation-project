...
{
    public class AddUserWeekProjectCommand : IRequest<UserWeekProjectEntity>
    {
        ...
        public AddUserWeekProjectCommand(int Id, string ProjectName, string Quotation, int NoAppMonday, int NoAppTuesday, int NoAppWednesday, int NoAppThursday, int NoAppFriday, int NoAppSaturday, int NoAppSunday, string MondayStatus, string TuesdayStaus, string WednesdayStatus, string ThursdayStatus, string FridayStatus, string SaturdayStatus, string SundayStatus, int AppMonday, int AppTuesday, int AppWednesday, int AppThursday, int AppFriday, int AppSaturday, int AppSunday, int Bonus, int TotalApp, int TotalNoApp, int WeekId, int UserId)
        {
            this.Id = Id;
