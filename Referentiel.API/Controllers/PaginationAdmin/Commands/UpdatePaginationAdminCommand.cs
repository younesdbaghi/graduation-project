...
{
    public class UpdatePaginationAdminCommand : IRequest<int>
    {
        ...
        public UpdatePaginationAdminCommand(int Id, int PagAdminUsers, int PagAdminPublications, int PagAdminProjects, int PagAdminQuotations, int UserId)
        {
            this.Id = Id;
